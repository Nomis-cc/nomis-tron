...
{
    /// <summary>
    /// Tron wallet score calculator.
    /// </summary>
    internal static class TronScoreCalculator
    {
        ...
        public static double GetScore(this IWalletStats<TronTransactionIntervalData> stats)
        {
            var result = 0.0;

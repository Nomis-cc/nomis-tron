...
namespace Nomis.Tronscan.Interfaces.Models
{
    ...
    /// Tron wallet stats.
    /// </summary>
    public class TronWalletStats
        : IWalletStats<TronTransactionIntervalData>
    {
        /// <summary>
        /// No data.
        /// </summary>
        ...
        /// <inheritdoc/>
        [Display(Description = "Wallet balance", GroupName = "TRX")]
        ...
        /// <inheritdoc/>
        [Display(Description = "The movement of funds on the wallet", GroupName = "TRX")]
        ...
        public IEnumerable<TronTransactionIntervalData>? TurnoverIntervals { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last month", GroupName = "TRX")]
        public decimal BalanceChangeInLastMonth { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last year", GroupName = "TRX")]
        ...
        /// <inheritdoc/>
        [Display(Description = "NFT trading activity", GroupName = "TRX")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Display(Description = "NFT worth on wallet", GroupName = "TRX")]
